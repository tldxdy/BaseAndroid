...
public class GlideUtils {
    ...
    public static void loadCircleImages(Context context, String url,int error, ImageView imageView) {
    ...
    public static void loadRoundCircleImage(Context context,int placeholderSoWhite, Object url, int radius, ImageView imageView) {
    ...
    public static void loadRoundCircleImage(Context context, Object url, int radius, ImageView imageView) {
